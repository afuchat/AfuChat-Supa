...
```bash
adb shell pm set-app-links --package com.afuchat.afuapp 2 afuchat.com www.afuchat.com
adb shell pm verify-app-links --re-verify com.afuchat.afuapp
```
