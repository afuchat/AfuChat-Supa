...
const SERVICES: Service[] = [
  ...
  { id: "internet", label: "Internet", icon: "globe", color: "#1f95ff", category: "Utilities", description: "Pay broadband & ISP bills", accountLabel: "Account / Username", accountPlaceholder: "ISP Account No.", amountSuggestions: [500, 1000, 2000, 5000] },
