...
const styles = StyleSheet.create({
  ...
  inputGroup: { borderRadius: 14, borderWidth: 0.5, paddingHorizontal: 16, paddingVertical: 13, gap: 6 },
  ...
  bottomBar: { paddingHorizontal: 16, paddingTop: 12, flexDirection: "row", gap: 10 },
  ...
  nextBtn: { flex: 1, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 8, paddingVertical: 15, borderRadius: 999 },
  ...
  pickerOption: { flexDirection: "row", alignItems: "center", gap: 12, paddingVertical: 14 },
  ...
  regSearchRow: { flexDirection: "row", alignItems: "center", gap: 8, borderRadius: 10, borderWidth: 0.5, paddingHorizontal: 12, paddingVertical: 10 },
  regSearchInput: { flex: 1, fontSize: 14, fontFamily: "Inter_400Regular", paddingVertical: 0 },
  regResultsList: { borderRadius: 12, borderWidth: 0.5, overflow: "hidden", marginTop: 2 },
  regResultRow: { flexDirection: "row", alignItems: "center", gap: 10, paddingHorizontal: 14, paddingVertical: 12 },
