...
const styles = StyleSheet.create({
  ...
  socialsRow: { flexDirection: "row", flexWrap: "wrap", gap: 8, paddingTop: 12 },
  ...
  aboutBox: { paddingTop: 12, gap: 6, paddingBottom: 4 },
  ...
  detailsBox: { paddingTop: 10, gap: 8, paddingBottom: 4 },
  ...
  tabs: { flexDirection: "row", alignItems: "center", marginTop: 10 },
