                  ...
                  <View style={[styles.postSection, { backgroundColor: colors.surface }]}>
                    <View style={styles.postHeader}>
                      <TouchableOpacity onPress={() => router.push(`/@${post.author.handle}` as any)}>
                        <Avatar uri={post.author.avatar_url} name={post.author.display_name} size={46} userId={post.author.id} />
                      </TouchableOpacity>
                      <View style={{ flex: 1 }}>
                        <View style={styles.nameRow}>
                          <TouchableOpacity onPress={() => router.push(`/@${post.author.handle}` as any)}>
                            <UserName userId={post.author.id} name={post.author.display_name} style={[styles.authorName, { color: colors.text }]} />
                          </TouchableOpacity>
                ...
                <View style={{ backgroundColor: colors.surface }}>
                  ...
                  <View style={styles.articleContentPad}>
                    <View style={[styles.authorByline, { borderColor: colors.border }]}>
                      <TouchableOpacity onPress={() => router.push(`/@${post.author.handle}` as any)}>
                        <Avatar uri={post.author.avatar_url} name={post.author.display_name} size={38} userId={post.author.id} />
                      </TouchableOpacity>
                      <View style={{ flex: 1 }}>
                        <View style={styles.nameRow}>
                          <TouchableOpacity onPress={() => router.push(`/@${post.author.handle}` as any)}>
...
const styles = StyleSheet.create({
  ...
  engagementBar: { flexDirection: "row", alignItems: "center", marginTop: 4 },
  ...
  composerBar: { flexDirection: "row", alignItems: "flex-end", gap: 10, paddingHorizontal: 12, paddingTop: 10 },
  ...
  replyingBanner: { flexDirection: "row", alignItems: "center", paddingHorizontal: 14, paddingVertical: 8 },
  replyingText: { fontSize: 13, fontFamily: "Inter_400Regular" },
  signInBar: { paddingHorizontal: 16, paddingTop: 10 },
  ...
  authorByline: { flexDirection: "row", alignItems: "center", gap: 10, paddingBottom: 16, marginBottom: 14 },
